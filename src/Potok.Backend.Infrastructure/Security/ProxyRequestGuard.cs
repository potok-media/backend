...
/// <summary>
///     Общий SSRF-guard для проксирующих эндпоинтов (Gateway /api/proxy и SearchEngine balancers proxy).
///     Блокирует loopback / private / reserved адреса и не-HTTP схемы.
/// </summary>
